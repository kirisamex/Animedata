...
namespace Main
{
    public partial class CompanyManage : Form
    {
        ...
        //数据集
        ClientDS.CompanyListDataTable companyList = new ClientDS.CompanyListDataTable();
        ClientDS.CompanyHistDataTable companyHist = new ClientDS.CompanyHistDataTable();
        ...
        /// 载入公司界面
        /// </summary>
        public void ShowCompanyInfo(DataSet ds)
        {
            ...
            try
            {
                ...
                {
                    ClientDS.CompanyListRow clr = companyList.NewCompanyListRow();
                ...
                {
                    ClientDS.CompanyHistRow chr = companyHist.NewCompanyHistRow();
        ...
        private void ShowCompanyHistInfo(Company cmp)
        {
            ...
            foreach (ClientDS.CompanyHistRow chr in targetHists)
            {
        ...
        private bool UpdateCompany()
        {
            ...
            foreach (DataGridViewRow dr in CompanyDataGridView.Rows)
            {
                ...
                foreach (ClientDS.CompanyListRow clr in targetCmp)
                {
