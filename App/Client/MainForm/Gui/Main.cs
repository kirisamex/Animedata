...
using AnimeHistDataTable = Client.ClientDataSet.ClientDataSet.AnimeHistDataTable;
using AnimeListDataTable = Client.ClientDataSet.ClientDataSet.AnimeListDataTable;
using PlayInfoHistDataTable = Client.ClientDataSet.ClientDataSet.PlayInfoHistDataTable;
using PlayInfoListDataTable = Client.ClientDataSet.ClientDataSet.PlayInfoListDataTable;
using CVHistDataTable = Client.ClientDataSet.ClientDataSet.CVHistDataTable;
using CVListDataTable = Client.ClientDataSet.ClientDataSet.CVListDataTable;
...
namespace Client.MainForm.Gui
{
    public partial class Main : Form
    {
        ...
        //数据集
        AnimeHistDataTable AnimeHist = new AnimeHistDataTable();
        AnimeListDataTable AnimeList = new AnimeListDataTable();
        PlayInfoHistDataTable PlayInfoHist = new PlayInfoHistDataTable();
        PlayInfoListDataTable PlayInfoList = new PlayInfoListDataTable();
        CVHistDataTable CVHist = new CVHistDataTable();
        CVListDataTable CVList = new CVListDataTable();
        ...
        public void LoadAnime()
        {
            ...
            {
                //获取动画信息
                System.Data.DataSet ds = service.Getanime();
        ...
        public void ShowCharacterInfo(string animeNo)
        {
            try
            {
                System.Data.DataSet ds = service.LoadCharacterInfo(animeNo);
        ...
        public static Main Mainfm = null;
        /// <summary>
        /// 主窗体
        /// </summary>
        public Main()
        ...
        private void 添加动画信息ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                AddAnime fm = new AddAnime(AnimeCommand.Command.Add, null);
                fm.Show();
